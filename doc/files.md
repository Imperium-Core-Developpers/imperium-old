...
* imperium.conf: contains configuration settings for imperiumd or imperium-qt
* imperiumd.pid: stores the process id of imperiumd while running
...
* debug.log: contains debug information and general logging generated by imperiumd or imperium-qt
