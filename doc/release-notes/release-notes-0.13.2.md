Imperium Core version 0.13.2 is now available from:

  <https://imperium.org/bin/imperium-core-0.13.2/>
...
- #8908 `4a974b2` Update imperium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow imperium-tx to create v2 transactions (impdrak)
