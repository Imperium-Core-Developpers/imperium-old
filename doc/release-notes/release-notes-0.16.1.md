Imperium Core version 0.16.1 is now available from:

  <https://imperiumcore.org/bin/imperium-core-0.16.1/>
...
- #12843 `df38b13` Test starting imperiumd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure imperiumd processes are cleaned up when tests end (sdaftuar)
