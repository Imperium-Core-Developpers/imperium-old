Download URL: https://sourceforge.net/projects/imperium/files/Imperium/imperium-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 IMP fee schedule (users still pay 0.01 IMP per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #imperium00 - #imperium99
