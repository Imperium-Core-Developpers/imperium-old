Imperium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/imperium/files/Imperium/imperium-0.5.4/
...
http://gitorious.org/imperium/imperiumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Imperium-Qt notifications under Growl 1.3.
Increase required age of Imperium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxImperium properly when installing Imperium-Qt over it. (Windows)
