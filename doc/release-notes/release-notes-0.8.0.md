Imperium-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/imperium/files/Imperium/imperium-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Imperium
...
New/changed settings (command-line or imperium.conf file)
--------------------------------------------------------
