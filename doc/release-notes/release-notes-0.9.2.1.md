Imperium Core version 0.9.2.1 is now available from:

  https://imperium.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 IMP to 0.01 IMP
...
- Fix "Start imperium on system login"
