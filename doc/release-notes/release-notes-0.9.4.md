Imperium Core version 0.9.4 is now available from:

  https://imperium.org/bin/0.9.4/
...
this update is incompatible with the Imperium system and could lead to consensus
forks.

Imperium Core released binaries from https://imperium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~imperium/+archive/ubuntu/imperium
- A third-party or self-compiled Imperium Core

upgrade to Imperium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
