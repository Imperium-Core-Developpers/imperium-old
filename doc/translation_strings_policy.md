...
This document provides guidelines for internationalization of the Imperium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `imperium_en.ts` remains unchanged.
