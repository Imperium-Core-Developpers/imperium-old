...
static void SetupImperiumTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " imperium-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  imperium-tx [options] <hex-tx> [commands]  Update hex-encoded imperium transaction\n" +
            "or:     imperium-tx [options] -create [commands]   Create hex-encoded imperium transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded imperium transaction
