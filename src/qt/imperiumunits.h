...
/** Imperium unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ImperiumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ImperiumUnits(QObject *parent);

    /** Imperium units.
      @note Source: https://en.imperium.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        IMP,
    ...
    //! Return maximum number of base units (Votes)
    static CAmount maxMoney();

private:
    QList<ImperiumUnits::Unit> unitlist;
};
typedef ImperiumUnits::Unit ImperiumUnit;
