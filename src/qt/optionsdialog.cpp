    ...
    mapper(0)
{
    ...
    ui->imperiumAtStartup->setToolTip(ui->imperiumAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->imperiumAtStartup->setText(ui->imperiumAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openImperiumConfButton->setToolTip(ui->openImperiumConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ImperiumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->imperiumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openImperiumConfButton_clicked()
{
