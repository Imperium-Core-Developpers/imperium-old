...
static void TestPackageSelection(const CChainParams& chainparams, const CScript& scriptPubKey, const std::vector<CTransactionRef>& txFirst) EXCLUSIVE_LOCKS_REQUIRED(::mempool.cs)
{
    ...
    // This tx has a low fee: 1000 votes
    uint256 hashParentTx = tx.GetHash(); // save this txid for later use
    mempool.addUnchecked(hashParentTx, entry.Fee(1000).Time(GetTime()).SpendsCoinbase(true).FromTx(tx));

    // This tx has a medium fee: 10000 votes
    ...
    tx.vout[0].nValue = 5000000000LL - 1000 - 50000; // 50k vote fee
    ...
    tx.vout[1].nValue = 100000000; // 1IMP output
    ...
    tx.vout[0].nValue = 100000000 - 10000; // 10k vote fee
