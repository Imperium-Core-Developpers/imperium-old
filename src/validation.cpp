...
#if defined(NDEBUG)
# error "Imperium cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Imperium Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept)
{
...

    {
        ...
        for (CTxMemPool::txiter it : allConflicting)
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s IMP additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    //CAmount nSubsidy = 50 * COIN;
      ...
      CAmount nSubsidy = (nHeight == 0 ? 37800000 : 50) * COIN;
...
void ThreadScriptCheck() {
    RenameThread("imperium-scriptch");
