...
"""Verify that starting imperium with -h works as expected."""

from test_framework.test_framework import ImperiumTestFramework
from test_framework.util import assert_equal

class HelpTest(ImperiumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start imperium with -h for help text")
        ...
        self.log.info("Start imperium with -version for version information")
        ...
        self.log.info("Start imperiumd with -fakearg to make sure it does not start")
