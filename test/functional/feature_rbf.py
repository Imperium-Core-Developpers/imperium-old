...
from test_framework.util import assert_equal, assert_raises_rpc_error, bytes_to_hex_str, vote_round
...
class ReplaceByFeeTest(ImperiumTestFramework):
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 40 IMP - so this attempt is rejected.
        dbl_tx = CTransaction()
